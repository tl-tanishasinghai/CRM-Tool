...
/** Exception thrown when a drawdown is rejected by the risk dedupe framework. */
public class DrawdownRiskRejectedException extends BaseException {

  public DrawdownRiskRejectedException(String message) {
    super(message, null, HttpStatus.BAD_REQUEST);
  }

  public DrawdownRiskRejectedException(String message, Object clientResponse) {
    super(message, clientResponse, HttpStatus.BAD_REQUEST);
  }

  public DrawdownRiskRejectedException(
