...
/** Exception thrown when drawdown document reference persistence fails. */
public class DrawdownDocumentPersistenceException extends BaseException {

  public DrawdownDocumentPersistenceException(String message) {
    super(message, null, HttpStatus.INTERNAL_SERVER_ERROR);
  }

  public DrawdownDocumentPersistenceException(String message, Object clientResponse) {
    super(message, clientResponse, HttpStatus.INTERNAL_SERVER_ERROR);
  }

  public DrawdownDocumentPersistenceException(
