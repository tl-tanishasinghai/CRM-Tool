...
public class KafkaLoggingService {
            ...
            logEventJson ->
                Mono.fromFuture(kafkaTemplate.send(topicName, logEventJson).toCompletableFuture())
                    ...
                    .doOnError(
                        ...
                        e -> {
                          log.error(
                              "Unexpected runtime error while sending to kafka topic: {},"
                                  + " requestId: {}, traceId: {}, loggerHeader: {}",
                              topicName,
                              logEventDTO.getRequestId(),
                              logEventDTO.getTraceId(),
                              logEventDTO.getLoggerHeader(),
  ...
  /**
   * Creates a LogEventsDTO object based on the provided parameters.
   *
   * @param uri the URI of the request
   * @param method the HTTP method used for the request
   * @param requestBody the request body object
   * @param partnerCode the partner code associated with the request
